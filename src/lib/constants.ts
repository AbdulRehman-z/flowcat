...
export const SELECT_CATEGORY_ITEM = [
  { value: "development", label: "Development", color: "text-blue-500" },
  { value: "marketing", label: "Marketing", color: "text-red-500" },
  { value: "design", label: "Design", color: "text-purple-500" },
  { value: "productivity", label: "Productivity", color: "text-green-500" },
  { value: "management", label: "Management", color: "text-yellow-500" },
  { value: "health", label: "Health", color: "text-teal-500" },
  { value: "learning", label: "Learning", color: "text-orange-500" },
];
