...
import { Clock, DollarSign, Star, Shield, Users, Briefcase, TrendingUp, Globe2, ChevronDown } from "lucide-react"
import { useState } from "react"
import { motion, AnimatePresence } from "framer-motion"
import { initializeScraper, loginToUpwork } from "@/lib/jobs/upwork-auth"
...
export function JobCard() {
  ...
  // const login = loginToUpwork(browser, page)
  const { jobs, isScraping } = useScrapeJobs()
  // if (!login) return <div>Login failed</div>
